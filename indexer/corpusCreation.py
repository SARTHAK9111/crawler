...
class HTMLParser:
    def __init__(self):
        self.data = []
        self.output_filename = "E:/IR/IRProject/Web_Crawler_Sarthak/f1_crawler/f1_records.json"  # Specify the output JSON file path here
...
if __name__ == "__main__":
    html_directory = "E:/IR/IRProject/Web_Crawler_Sarthak/f1_crawler/documents"  # Specify the directory containing HTML files
